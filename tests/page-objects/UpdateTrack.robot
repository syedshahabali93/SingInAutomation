...
*** Keywords ***
    ...
    page should contain element    //*[contains(text(),"YouTube ID")]
    element should be visible    //*[contains(text(),"YouTube ID")]
    page should contain element    //*[contains(text(),"Lyrics")]
    element should be visible    //*[contains(text(),"Lyrics")]
    page should contain element    //*[contains(text(),"Tags")]
    element should be visible    //*[contains(text(),"Tags")]
    page should contain element    //*[contains(text(),"Explicit cover")]
    ...
    input text    //*[contains(text(),"Lyrics")]    ${lyrics}
    input text    //*[contains(text(),"Tags")]      ${tag}
    click element    //*[contains(text(),"Save")]
    click element    //*[contains(text(),"Explicit cover")]
